...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_gallery_images", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_gallery_settings", x => x.Key));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_meeting_hidden_static", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_contact_info", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_link_categories", x => x.Id));
    ...
    {
        migrationBuilder.DropTable(name: "link_items");
        migrationBuilder.DropTable(name: "link_categories");
        migrationBuilder.DropTable(name: "gallery_images");
        migrationBuilder.DropTable(name: "gallery_settings");
        migrationBuilder.DropTable(name: "meetings");
        migrationBuilder.DropTable(name: "meeting_hidden_static");
        migrationBuilder.DropTable(name: "contact_info");
    }
}
